...
HelloGitHub 推出的[《讲解开源项目》](https://github.com/HelloGitHub-Team/Article) 系列。这一期是由亚马逊工程师：[Keerthan Vasist](https://github.com/keerthanvasist)，为我们讲解 DJL（完全由 Java 构建的深度学习平台）系列的第 4 篇。
